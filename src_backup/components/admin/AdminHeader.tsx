        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80 mt-2 rounded-2xl p-0 shadow-2xl border-gray-100 overflow-hidden">
            ...
            <div className="max-h-[300px] overflow-y-auto">
              {notifications.length > 0 ? (
                notifications.map((notification: any, index: number) => (
                  ...
                  >
                    <Link to={notification.type === 'order' ? '/admin/orders' : '/admin/messages'} className="flex items-start gap-3 w-full">
            ...
            <div className="p-2 bg-gray-50/50 border-t border-gray-100 text-center">
              <Link to="/admin" className="text-[10px] font-bold text-maroon hover:underline uppercase tracking-wider">
                View All Activity
              </Link>
            </div>
          </DropdownMenuContent>
