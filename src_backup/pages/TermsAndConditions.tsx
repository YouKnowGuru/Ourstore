...
import licenseImg from '@/lib/Licence_page-0001.jpg';
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="relative group rounded-[3rem] overflow-hidden border-8 border-white shadow-2xl bg-white">
                                ...
                                <img
                                    ...
                                    onError={(e) => {
                                        (e.target as HTMLImageElement).src = 'https://placehold.co/1200x1600/white/8B2635?text=Business+License+Verified';
                                    }}
                                />
                            </div>
