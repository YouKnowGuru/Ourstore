...
const getEmailTemplate = (content, title = 'Our Store Bhutan') => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
const sendOTPEmail = async (email, otp, purpose = 'verification') => {
  ...
  const content = `
    ...
    <tr>
      <td style="background: linear-gradient(135deg, #FF6B35 0%, #8B2635 100%); padding: 50px 30px; text-align: center; position: relative;">
    ...
    <tr>
      ...
      : 'Thank you for signing up! Please use the verification code below to confirm your email address:'}
        ...
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border: 3px dashed #FF6B35; border-radius: 12px; padding: 30px; text-align: center; margin: 30px 0;">
          ...
          <div style="font-size: 42px; font-weight: 800; color: #8B2635; letter-spacing: 8px; font-family: 'Courier New', monospace; text-shadow: 2px 2px 4px rgba(0,0,0,0.1);">
            ${otp}
          </div>
        </div>
...
const sendOrderConfirmation = async (email, order) => {
  const content = `
    ...
    <tr>
      <td style="padding: 50px 40px;">
        <h2 style="color: #1a1a2e; margin: 0 0 20px 0; font-size: 24px; font-weight: 600;">
          Your order is confirmed! 🛍️
        </h2>
        
        <p style="color: #4a4a4a; font-size: 16px; line-height: 1.6; margin: 0 0 30px 0;">
          We're getting your order ready and will notify you when it ships. Here are your order details:
        </p>
          ...
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              <td style="padding: 12px 0; border-bottom: 1px solid #dee2e6;">
                <span style="color: #6c757d; font-size: 14px;">Order Number</span>
              </td>
              <td style="padding: 12px 0; text-align: right; border-bottom: 1px solid #dee2e6;">
                <span style="color: #1a1a2e; font-size: 16px; font-weight: 700;">${order.orderNumber}</span>
              </td>
            </tr>
            <tr>
              <td style="padding: 12px 0; border-bottom: 1px solid #dee2e6;">
              ...
              <td style="padding: 12px 0; text-align: right; border-bottom: 1px solid #dee2e6;">
                <span style="color: #1a1a2e; font-size: 16px; font-weight: 600;">${new Date(order.createdAt).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
              </td>
            </tr>
            <tr>
              ...
              <td style="padding: 12px 0; text-align: right;">
                <span style="color: #10b981; font-size: 24px; font-weight: 800;">Nu. ${order.total.toFixed(2)}</span>
              </td>
            </tr>
          </table>
        </div>
        ...
        <p style="color: #4a4a4a; font-size: 15px; line-height: 1.6; margin: 30px 0 0 0; text-align: center;">
      ...
      <td style="padding: 50px 40px;">
        ...
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 12px; padding: 30px; margin: 30px 0; border: 1px solid #dee2e6;">
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              <td style="padding: 12px 0; border-bottom: 1px solid #dee2e6;">
                <span style="color: #6c757d; font-size: 14px;">Current Status</span>
              </td>
              <td style="padding: 12px 0; text-align: right; border-bottom: 1px solid #dee2e6;">
                <span style="display: inline-block; background: ${config.color}; color: white; padding: 6px 16px; border-radius: 20px; font-size: 14px; font-weight: 600;">
                  ${config.emoji} ${status}
                </span>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding: 12px 0;">
                <span style="color: #6c757d; font-size: 14px;">Tracking Number</span>
              </td>
              <td style="padding: 12px 0; text-align: right;">
                <span style="color: #1a1a2e; font-size: 16px; font-weight: 700; font-family: 'Courier New', monospace;">${order.trackingNumber}</span>
              </td>
            </tr>
            ` : ''}
          </table>
        ...
        <div style="background: #dbeafe; border-left: 4px solid #3b82f6; padding: 20px; border-radius: 8px; margin: 30px 0;">
          <p style="margin: 0; color: #1e40af; font-size: 15px; line-height: 1.6;">
            📍 <strong>On the way!</strong> Your package is on its way to you. You can track your shipment using the tracking number above.
          </p>
        </div>
        ` : ''}
        ...
        <div style="background: #d1fae5; border-left: 4px solid #10b981; padding: 20px; border-radius: 8px; margin: 30px 0;">
          <p style="margin: 0; color: #065f46; font-size: 15px; line-height: 1.6;">
            🎊 <strong>Delivered!</strong> Your order has been successfully delivered. We hope you enjoy your purchase!
          </p>
        </div>
        ` : ''}
